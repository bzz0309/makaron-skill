...
- 默认使用“国家队启发式球衣配色”：Brazil-inspired yellow jersey/blue shorts、Germany-inspired white jersey/black trim、Spain-inspired red jersey/navy shorts、Argentina-inspired sky-blue white stripes、France-inspired blue kit、England-inspired white/navy、Portugal-inspired red/green、Netherlands-inspired orange。主角和对手必须来自不同国家配色，不能同色同队。
...
如果用户没有指定国家，默认随机选择一个强队配色给主角，并选择另一个不同国家配色作为对手：

- 主角默认优先：Brazil-inspired yellow jersey, blue shorts, white socks with green trim。
- 对手默认优先：Germany-inspired white jersey, black trim, black shorts。
...
- 主角和对手的球衣颜色必须明显不同，并且看起来像国际大赛国家队配色。默认 Brazil-inspired yellow/blue 主角对 Germany-inspired white/black 对手。
